...
complete --command psk --exclusive --argument copy \
    -n __fish_use_subcommand \
    --description 'Copy value of key to the clipboard'

complete --command psk --exclusive --argument show \
    -n __fish_use_subcommand \
    --description 'Print value of key'

complete --command psk --exclusive --argument list \
    -n __fish_use_subcommand \
